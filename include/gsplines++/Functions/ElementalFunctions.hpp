...
public:
  Identity(std::pair<double, double> _domain) : Function(_domain, 1) {}
...
public:
  Exponential(std::pair<double, double> _domain) : Function(_domain, 1) {}
...
public:
  Cos(std::pair<double, double> _domain) : Function(_domain, 1) {}
...
public:
  Sin(std::pair<double, double> _domain) : Function(_domain, 1) {}
