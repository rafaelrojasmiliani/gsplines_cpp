...
PYBIND11_MODULE(pygsplines, m) {
  py::class_<gsplines::basis::Basis, gsplines::basis::PyBasis>(m, "Basis")
      ...
      .def("eval_derivative_on_window", &gsplines::basis::Basis::eval_derivative_on_window)
      .def("eval_derivative_wrt_tau_on_window",
           &gsplines::basis::Basis::eval_derivative_wrt_tau_on_window);

  py::class_<gsplines::basis::BasisLegendre, gsplines::basis::Basis>(m, "BasisLegendre")
      .def(py::init<std::size_t>())
  ...
  py::class_<gsplines::PiecewiseFunction>(m, "PiecewiseFunction")
      ...
      .def("get_domain_breakpoints", &gsplines::PiecewiseFunction::get_domain_breakpoints)
  ...
  py::class_<gsplines::PyInterpolator, gsplines::Interpolator>(m, "PyInterpolator")
      .def(py::init<std::size_t, std::size_t, gsplines::basis::Basis &>())
      .def("interpolate", &gsplines::PyInterpolator::py_interpolate)
      .def("solve_interpolation", &gsplines::PyInterpolator::py_solve_interpolation)
  ...
  py::class_<gsplines::SobolevNorm>(m, "SobolevNorm")
      .def(py::init<const Eigen::Ref<const Eigen::MatrixXd>, gsplines::basis::Basis &,
                    std::vector<std::pair<std::size_t, double>>>())
      .def("__call__", &gsplines::SobolevNorm::operator())
      .def("deriv_wrt_interval_len", &gsplines::SobolevNorm::deriv_wrt_interval_len);

  py::class_<gsplines::PySobolevNorm>(m, "PySobolevNorm")
      .def(py::init<const py::EigenDRef<const Eigen::MatrixXd>, gsplines::basis::Basis &,
                    std::vector<std::pair<std::size_t, double>>>())
      .def("__call__", &gsplines::SobolevNorm::operator())
      .def("deriv_wrt_interval_len", &gsplines::SobolevNorm::deriv_wrt_interval_len);
  ...
  py::class_<gsplines::functions::PyFunction>(m, "Function")
      .def(py::init<std::pair<double, double>, std::size_t>())
      .def("get_codom_dim", &gsplines::functions::Function::get_codom_dim)
      .def("is_point_in_domain", &gsplines::functions::Function::is_point_in_domain)
      .def("get_domain", &gsplines::functions::Function::get_domain)
      .def("deriv", &gsplines::functions::PyFunction::deriv_wrapper)
      .def("__call__", &gsplines::functions::PyFunction::operator());

  // Function Expression
  py::class_<gsplines::functions::FunctionExpression>(m, "FunctionExpression")
      .def(py::init<std::pair<double, double>, std::size_t,
                    gsplines::functions::FunctionExpression::Type>())
      .def("get_codom_dim", &gsplines::functions::FunctionExpression::get_codom_dim)
      .def("is_point_in_domain", &gsplines::functions::FunctionExpression::is_point_in_domain)
      .def("get_domain", &gsplines::functions::FunctionExpression::get_domain)
      .def("deriv", &gsplines::functions::FunctionExpression::derivate)
      .def("__sum__", &gsplines::functions::FunctionExpression::sum)
      .def("__mul__", &gsplines::functions::FunctionExpression::mul)
